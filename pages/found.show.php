            ...
            <tbody>
              <?php foreach ($related_matches as $m): ?>
                <tr>
                  ...
                  <td data-label="Status" class="col-narrow"><?= status_badge((string) $m['status']) ?></td>
                  <td data-label="Proposed" class="col-narrow text-sm text-muted"><?= e(time_ago((string) $m['created_at'])) ?></td>

        ...
        <tbody>
          <?php foreach ($rows as $r): ?>
            <tr>
              ...
              <td class="col-narrow text-sm"><?= e((string) $r['storage_code']) ?></td>
              <td class="col-narrow text-sm text-muted">
                <?= e(date('M j, Y', strtotime((string) $r['date_found']))) ?>
              </td>
              <td class="col-narrow text-sm"><?= e((string) $r['finder_name']) ?></td>
              <td class="col-narrow"><?= status_badge((string) $r['status']) ?></td>
            </tr>
          <?php endforeach; ?>
        </tbody>
      </table>

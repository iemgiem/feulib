      ...
      <table class="data-table data-table-static">
        ...
        <tbody>
          <?php foreach ($rows as $row): ?>
            <tr>
              <td data-label="ITS ID" class="text-sm" style="font-family: var(--font-family-mono);">
                <?= e((string) $row['its_id']) ?>
              </td>
              <td data-label="Name"><?= e((string) $row['full_name']) ?></td>
              <td data-label="Email" class="text-sm text-muted"><?= e((string) ($row['email'] ?? '—')) ?></td>
              <td data-label="Role" class="col-narrow text-sm"><?= e(ucfirst((string) $row['role'])) ?></td>
              ...
              <td data-label="Synced" class="col-narrow text-sm text-muted">

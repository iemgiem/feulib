        ...
        <table class="data-table data-table-static">
          ...
          <tbody>
            <?php foreach ($recent as $r): ?>
              ...
              <tr>
                <td data-label="Type"><?= e(ucwords(str_replace('_', ' ', (string) $r['report_type']))) ?></td>
                <td data-label="Date range" class="text-sm">
                  <?= e((string) ($params['date_from'] ?? '—')) ?>
                  &ndash;
                  <?= e((string) ($params['date_to'] ?? '—')) ?>
                </td>
                <td data-label="Generated by"><?= e((string) $r['generated_by']) ?></td>
                <td data-label="When" class="col-narrow text-sm text-muted"><?= e(time_ago((string) $r['generated_at'])) ?></td>

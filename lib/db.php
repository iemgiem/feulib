 ...
 *
 * Nesting: if a transaction is already open (e.g. upload_record() called from
 * inside found.new.php's outer transaction), a named SAVEPOINT is used instead
 * of beginTransaction() — InnoDB supports SAVEPOINT/ROLLBACK TO SAVEPOINT
 * fully, so inner work is atomic without requiring a real nested transaction.
 */

...
<head>
  ...
  <link rel="stylesheet" href="<?= e(asset('css/tokens.css')) ?>?v=<?= filemtime(__DIR__ . '/../assets/css/tokens.css') ?>">
  <link rel="stylesheet" href="<?= e(asset('css/base.css')) ?>?v=<?= filemtime(__DIR__ . '/../assets/css/base.css') ?>">
  <link rel="stylesheet" href="<?= e(asset('css/components.css')) ?>?v=<?= filemtime(__DIR__ . '/../assets/css/components.css') ?>">
</head>
<body>
...
<?php
  ...
  <script src="<?= e(asset('js/release-verify.js')) ?>" defer></script>
</body>
</html>
<?php
}
...
function sidebar_items(string $role): array
{
    ...
    if ($role === 'admin') {
        ...
        $items[] = ['label' => 'Donate Items',    'href' => url('/index.php?p=admin.donate'),   'active_tokens' => ['admin.donate']];

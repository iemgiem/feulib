        ...
        <tbody>
          <?php foreach ($matches as $m): ?>
            <tr>
              ...
              <td data-label="Age" class="col-narrow text-sm text-muted">
        ...
        <tbody>
          <?php foreach ($claims as $c): ?>
            <tr>
              ...
              <td data-label="Submitted" class="col-narrow text-sm text-muted">
                <?= e(time_ago((string) ($c['submitted_at'] ?? $c['claim_created_at']))) ?>
              </td>
              <td data-label="Status" class="col-narrow"><?= status_badge((string) $c['claim_status']) ?></td>
              <td data-label="Action" class="col-actions">
